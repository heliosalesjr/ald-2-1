    ...
    <div className='max-w-7xl mx-auto p-4'>
        ...
        <div className="max-w-5xl mx-auto items-center justify-center py-8">
              <div className="attention-box mx-8 text-slate-800 text-center text-lg border-2 border-primary rounded-lg p-8">
                <p>
                    <a href="https://drive.google.com/file/d/1YGuqNR3ZsgFrm8vmEzyC7yvixnC08e0h/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="underline text-blue-800 hover:text-purple-800"> Veja aqui</a>{' '}como a professora Vilma e o professor André contextualizaram suas aulas de Matemática.
                </p>
